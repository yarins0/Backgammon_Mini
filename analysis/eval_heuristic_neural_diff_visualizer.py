...
def visualize_evaluation_results(results_file=None):
    """
    ...
    if results_file is None:
        results_file = os.path.join(_HERE, "evaluation_results.json")
    # Load results
    ...
    plt.savefig(os.path.join(_HERE, 'evaluation_comparison.png'), dpi=300)
    plt.show()
